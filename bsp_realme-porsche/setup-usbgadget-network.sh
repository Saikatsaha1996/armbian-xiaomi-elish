...
deviceinfo_name="Realme GT 2"
deviceinfo_manufacturer="Realme"
deviceinfo_codename="realme-porsche"
#deviceinfo_usb_idVendor=
#deviceinfo_usb_idProduct=
deviceinfo_usb_serialnumber="realme-porsche"
...
set_usbgadget_ipaddress() {
	...
	nohup /usr/local/bin/unudhcpd -i "$INTERFACE" -s "$host_ip" -c "$client_ip" 2>&1 >> /var/log/unudhcpd.log &
}
setup_usb_network_configfs
set_usbgadget_ipaddress
